  ...
  <section class="lg:col-span-2 flex flex-col items-center w-full lg:w-auto">
    ...
    >
      ...
      <div
        ...
        }  h-10 rounded-sm flex items-center justify-center font-bold border border-solid border-gray-300 col-start-3`"
      >
        S1
      </div>
      <div
        ...
        :class="`${
          findSeatStatus('S2') === 'Available'
            ...
            ? 'bg-green-500 text-white'
            : 'bg-gray-500 text-white'
        } h-10 rounded-sm flex items-center justify-center font-bold border border-solid border-gray-300`"
      >
        S2
      </div>
      <div
